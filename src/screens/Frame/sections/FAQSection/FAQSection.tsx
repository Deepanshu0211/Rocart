  ...
  const faqData = [
    {
      ...
      answer: "Yes, Rocart is a secure and trusted marketplace for gaming items. We use advanced security measures, SSL encryption, and have a verified seller system to ensure safe transactions for all our users."
    },
    {
      id: "item-2", 
      question: "What if I don't receive my items after purchasing?",
      answer: "If you don't receive your items within the specified delivery time, contact our 24/7 support team immediately. We offer full refunds or instant replacements for undelivered items with our buyer protection guarantee."
    },
    {
      id: "item-3",
      question: "What is your refund policy?",
      answer: "We offer a comprehensive 30-day refund policy for unused items. Digital items can be refunded within 24 hours if not redeemed. Physical items can be returned in original condition with free return shipping."
    },
    {
      id: "item-4",
      question: "Can I trade my in-game items for items on Rocart?",
      answer: "Absolutely! Our advanced trading system allows you to exchange your valuable in-game items for other items or store credit. Simply list your items, set your preferences, and connect with verified traders worldwide."
    },
    {
      id: "item-5",
      question: "How do I receive my purchased items?",
      answer: "Digital items are delivered instantly to your account or email within seconds of purchase. Physical items are shipped via express delivery to your address. You'll receive real-time tracking information for all orders."
    },
    {
      id: "item-6",
      question: "Can I get free items?",
      answer: "Yes! We regularly offer free items through daily login rewards, seasonal events, tournaments, giveaways, and our referral program. Follow us on social media and check our promotions page for the latest free drops!"
    },
  ];
                ...
                `}>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {/* Plus/Minus Icon */}
                      <div className={`
                        w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-500 ease-out
                        ${isOpen 
                      ...
                      `}>
                        {isOpen ? (
                          <Minus 
                            size={20}
                            className="text-[#0e2514] font-bold transition-all duration-300"
                          />
                        ) : (
                          <Plus 
                            size={20}
                            className="text-[#3dff87] transition-all duration-300"
                          />
                        )}
                      </div>
                    </div>
